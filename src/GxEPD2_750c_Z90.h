...
class GxEPD2_750c_Z90 : public GxEPD2_EPD
{
  public:
    ...
    void writeImage(const uint8_t channel, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert = false, bool mirror_y = false, bool pgm = false);
